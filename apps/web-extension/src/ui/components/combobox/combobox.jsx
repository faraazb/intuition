...
const Combobox = ({ items: itemsList = [], getFilter, onChange }) => {
  ...
  const {
    ...
    onSelectedItemChange({ selectedItem: newSelectedItem }) {
      ...
      onChange({
        type: "select",
        value:
          newSelectedItem !== null ? newSelectedItem.value : newSelectedItem,
      });
    },
    items,
    itemToString(item) {
...
const MultiCombobox = ({ items: itemsList = [], getFilter, onChange }) => {
      ...
      switch (type) {
        ...
        case useCombobox.stateChangeTypes.ItemClick:
          if (newSelectedItem != null) {
            ...
            onChange({
              type: "multi_select",
              value: newSelectedItems.map((item) =>
                item != null ? item.value : item
              ),
            });
          }
          break;
